...
static const char *fonts[]          = { "ttf-jetbrains-mono:size=15" }; static const char dmenufont[]       = "ttf-jetbrains-mono:size=15";
...
/*static const char *lfcmd[]  = { "st", "-e", "/bin/zsh", "-c", "lf", NULL };*/
